...
ShowImage(image1,"/Assets/Images/Projects/CultGame/PauseScreen.png", "Pause Screen of Cult Game");
ShowImage(image2,"/Assets/Images/Projects/CultGame/CultBook.png", "Starting point of the game");
ShowImage(image3,"/Assets/Images/Projects/CultGame/CultRitual.png", "Reactor from the game");
...
fetch("/Text/Projects/CultGame/Paragraph1.txt")
...
fetch("/Text/Projects/CultGame/Paragraph2.txt")
    .then(response => response.text())
    .then(data => {
...
fetch("/Text/Projects/CultGame/Paragraph3.txt")
    .then(response => response.text())
    .then(data => {
